...
with st.sidebar.expander("About the App"):
    st.write("""
        Word clouds play a major role in demonstrating what the text has to say. This application will help anyone to generate a word cloud of set dimensions and resolution.""")
st.title("Wordcloud Generator")  # set the title
...
im_shape = st.sidebar.file_uploader("Upload your shape as an jpg, image must have white backround (optional).", type='png')
...
try:
    ...
    st.markdown("##### Type your text in the box above & hit Enter!")  # set the sub header
